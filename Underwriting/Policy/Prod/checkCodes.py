...
url = 'http://underwriting.dca.zopa.com/policy'
driver.get(url)
...
if x != "1.0":
    print("mismatch")
    payload = {'color': 'red', 'message': 'Production UW Policy Rules check ran and do not match @all', 'notify': 'true', 'message_format': 'text'}
    ...
    payload = {'color': 'green', 'message': 'Production UW Policy Rules check ran and match', 'notify': 'true', 'message_format': 'text'}
    r = requests.post('https://api.hipchat.com/v2/room/2200616/notification?auth_token=g7wdJ7Qyijpd08iLTEdZH6Q74LgUYN6UQkG3eYQS', data=payload)
