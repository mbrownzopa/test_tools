...
url = 'http://underwriting.uat.ldn.zopa.com/segments'
driver.get(url)
...
if x != "1.0":
    print("mismatch")
    payload = {'color': 'red', 'message': 'UAT UW Segment Rules check ran and do not match @all', 'notify': 'true', 'message_format': 'text'}
    ...
    payload = {'color': 'green', 'message': 'UAT UW Segment Rules check ran and match', 'notify': 'true', 'message_format': 'text'}
    r = requests.post('https://api.hipchat.com/v2/room/2200616/notification?auth_token=g7wdJ7Qyijpd08iLTEdZH6Q74LgUYN6UQkG3eYQS', data=payload)
